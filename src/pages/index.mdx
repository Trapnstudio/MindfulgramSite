...
| Before                                                                                            | After                                                                                                |
| ------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| ![alt text](/img/screenshots/before/InstagramSuggestedPosts.png 'Hide Instagram suggested posts') | ![alt text](/img/screenshots/after/HideInstagramSuggestedPosts.png 'Hide Instagram suggested posts') |
...
| Before                                                                                      | After                                                                                          |
| ------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- |
| ![alt text](/img/screenshots/before/InstagramExplorePage.png 'Hide Instagram explore page') | ![alt text](/img/screenshots/after/HideInstagramExplorePage.png 'Hide Instagram explore page') |
...
| Before                                                                         | After                                                                             |
| ------------------------------------------------------------------------------ | --------------------------------------------------------------------------------- |
| ![alt text](/img/screenshots/before/InstagramReels.png 'Hide Instagram reels') | ![alt text](/img/screenshots/after/HideInstagramReels.png 'Hide Instagram reels') |
...
| Before                                                                             | After                                                                                 |
| ---------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- |
| ![alt text](/img/screenshots/before/InstagramStories.png 'Hide Instagram Stories') | ![alt text](/img/screenshots/after/HideInstagramStories.png 'Hide Instagram Stories') |
...
| Before                                                                               | After                                                                                   |
| ------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------- |
| ![alt text](/img/screenshots/before/InstagramComments.png 'Hide Instagram comments') | ![alt text](/img/screenshots/after/HideInstagramComments.png 'Hide Instagram comments') |
...
**[Mindfulgram Arc boost on Arcboosts](https://arcboosts.com/boosts/161/mindfulgram)**
