...
| Before                                                                 | After                                                                                    |
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------------------------- |
| ![alt text](/img/Screenshots/InstagramStories.png 'Instagram Stories') | ![alt text](/img/ProcessedScreenshots/HideInstagramStories.png 'Hide Instagram Stories') |
...
| Before                                                                                | After                                                                                                   |
| ------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------- |
| ![alt text](/img/Screenshots/InstagramSuggestedPosts.png 'Instagram suggested posts') | ![alt text](/img/ProcessedScreenshots/HideInstagramSuggestedPosts.png 'Hide Instagram suggested posts') |
...
| Before                                                                   | After                                                                                      |
| ------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------ |
| ![alt text](/img/Screenshots/InstagramComments.png 'Instagram comments') | ![alt text](/img/ProcessedScreenshots/HideInstagramComments.png 'Hide Instagram comments') |
...
| Before                                                                          | After                                                                                             |
| ------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| ![alt text](/img/Screenshots/InstagramExplorePage.png 'Instagram explore page') | ![alt text](/img/ProcessedScreenshots/HideInstagramExplorePage.png 'Hide Instagram explore page') |
...
| Before                                                             | After                                                    |
| ------------------------------------------------------------------ | -------------------------------------------------------- |
| ![alt text](/img/Screenshots/InstagramReels.png 'Instagram reels') | ![alt text](/img/mindfulgram.png 'Hide Instagram reels') |
